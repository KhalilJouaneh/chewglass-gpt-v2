...
const Markdown = ({ markdown, baseUrl, articleUrl }) => {
  return (
    <div
      style={{
        color: "white",
      ...
      <ReactMarkdown
        ...
        components={{
          a: ({ node, children }) => {
            ...
            return (
              <a target="_blank" href={finalHref} rel="noreferrer">
                {title ? "  #" : children}
              </a>
            );
          },
          ...
          h2: ({ children, ...props }) => <h2>{children}</h2>,
          h3: ({ children, ...props }) => <h3>{children}</h3>,
          h4: ({ children, ...props }) => <h4>{children}</h4>,
          h5: ({ children, ...props }) => <h5>{children}</h5>,
          h6: ({ children, ...props }) => <h6>{children}</h6>,
          p: ({ children, ...props }) => (
